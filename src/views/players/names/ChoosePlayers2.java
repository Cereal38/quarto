...
// player1TextField = new CustomTextField(new TranslatedString("player1"),
// "Enter Player 1's name");
// player2TextField = new CustomTextField(new TranslatedString("player2"),
...
// EventsHandler.getController().createModel(player1IsAI ? 1 : 0, player2IsAI ?
// 1 : 0,
...
// player1TextField.getDocument().addDocumentListener(new
// TextFieldChangeListener(this));
// player2TextField.getDocument().addDocumentListener(new
// TextFieldChangeListener(this));
// }

// private void createToggleButton(CustomTextField textField, JComboBox<String>
// difficultyComboBox, int numPlayer) {
...
// String[] difficultyLevels = { "Easy", "Medium", "Hard" }; // Define
// difficulty options
// JComboBox<String> comboBox = new JComboBox<>(difficultyLevels); // Create
// combo box
