...
public class QuartoModel {
    ...
    public QuartoModel(int firstPlayerType, int secondPlayerType, String firstPlayerName, String secondPlayerName,
        ...
        file = new QuartoFile();
        manager = new SlotManager();
        playerManager = new QuartoPlayerManager(firstPlayerType, secondPlayerType, firstPlayerName, secondPlayerName,
    ...
    public void selectPawnHuman(int indexPawn) {
        if (board.getSelectedPawn() == null && !hasAWinner() && !isATie()) {
            ...
            file.getSave().setNext(new QuartoHistory(indexPawn, file.getSave(),
                    playerManager.getNameOfTheCurrentPlayer(), playerManager.getCurrentPlayer()));
    ...
    public void saveFile(String fileName) throws IOException {
        ...
        try {
            ...
            file.saveFile(filePath, playerManager.getPlayer1Name(), playerManager.getPlayer2Name(),
